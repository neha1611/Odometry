...
# query_FeatureDataSet = ("SELECT * FROM (SELECT train_min_idx TrainMinIdx, Seconds, 'LeftAxleSpeed' Feature, left_axle_speed Speed"
# 					+" FROM odometry.tbl_fine_feature "
# 					+" Union "
# 					+" SELECT train_min_idx TrainMinIdx, Seconds, 'RightAxleSpeed' Feature, right_axle_speed Speed "
# 					+" FROM odometry.tbl_fine_feature "
# 					+" Union "
# 					+" SELECT train_min_idx TrainMinIdx, Seconds, 'OdoSpeed' Feature, odo_speed Speed "
# 					+" FROM odometry.tbl_fine_feature) AS FEATURE_TABLE"
# 					+" WHERE TrainMinIdx = {train_min_idx} "
# 					+" ORDER BY TrainMinIdx, Seconds")
